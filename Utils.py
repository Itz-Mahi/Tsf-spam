...
RRAID = [
    ...
    "CHODU",
    "RANDI",
    "RANDI KI TSF SE BAKCHODI KREGA",
    "TERIIIII MAAA KO BHEJJJ",
    "TERAA BAAAAP HU MADARCHOD",
    ...
    "TERIII MAA KE BHOXXDE ME AAG LGA DI RAPSTAR NE ",
    "MADARXHODDD",
    "TERIUUI MAAA KAA BHSODAAA",
    "TERIIIIII BEHENNNN KO CHODDDUUUU MADARXHODDDD",
    "NIKAL MADARCHOD",
    "RAPSTAR TERA BAAP HAI 🤣",
    "𝗧𝗘𝗥𝗜 𝗠𝗔𝗔 𝗞𝗔 𝗥𝗔𝗣𝗘 𝗞𝗥 𝗗𝗜𝗬𝗔 𝗧𝗦𝗙 𝗡𝗘 ",
    "TERI SEXY BEHEN KI CHOOT MAAR LI RAPSTAR NE",
]
