...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await idk(functions.channels.JoinChannelRequest(channel="KGFLONDA"))
            await idk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await idk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await idk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await ydk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await ydk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await ydk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await ydk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@Secret_ciyy"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await sid(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await sid(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await sid(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await sid(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await shy(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await shy(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await shy(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await shy(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await aan(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await aan(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await aan(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await aan(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await ake(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await ake(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await ake(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await ake(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await eel(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await eel(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await eel(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await eel(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await khu(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await khu(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await khu(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await khu(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await shi(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await shi(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await shi(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await shi(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await yaa(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await yaa(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await yaa(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await yaa(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await dav(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await dav(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await dav(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await dav(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await raj(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await raj(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await raj(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await raj(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await put(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await put(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await put(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await put(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tsix:
        ...
        try:
            ...
            await eag(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await eag(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await eag(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await eag(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await eag(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tseven:
        ...
        try:
            ...
            await gle.start()
            await gle(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await gle(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await gle(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await gle(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await gle(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
    ...
    if teight:
        ...
        try:
            ...
            await wal.start()
            await wal(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await wal(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await wal(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await wal(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
    ...
    if tnine:
        ...
        try:
            ...
            await aaa.start()
            await aaa(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await aaa(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await aaa(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await aaa(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await aaa(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
    ...
    if thirty:
        ...
        try:
            ...
            await boy.start()
            await boy(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await boy(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await boy(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await boy(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await boy(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 5:
            bio = str(yukki[0])
            text = " 𝗧𝗦𝗙 𝗖𝗛𝗔𝗡𝗚𝗜𝗡𝗚 𝗕𝗜𝗢 🔥"
            event = await e.reply(text, parse_mode=None, link_preview=None )
            try:
                await e.client(functions.account.UpdateProfileRequest(about=bio))
                await event.edit("𝗧𝗦𝗙 𝗠𝗔𝗔 𝗖𝗛𝗢𝗗𝗘𝗚𝗔")
            except Exception as e:
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            ...
            try:
                ...
                await event.edit("𝗛𝗢 𝗚𝗬𝗔 𝗝𝗢𝗜𝗡 𝗔𝗕 𝗕𝗧𝗔 𝗞𝗜𝗦𝗞𝗜 𝗠𝗔𝗔 𝗖𝗛𝗢𝗗𝗡𝗜 𝗛𝗔𝗜")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
